...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute w-[400px] h-[400px] rounded-full blur-3xl opacity-30 bg-[var(--accent-primary)] pointer-events-none"
        style={{
          top: "25%",
          left: "50%",
          transform: `translateX(-50%) translate(${orbTransform.x}px, ${orbTransform.y}px)`,
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Title */}
          <p
            className="text-base sm:text-lg md:text-xl text-[var(--text-secondary)] mb-6 font-medium flex flex-wrap justify-center items-center gap-2 sm:gap-3"
            style={{
              transform: `
          ...
          <p className="text-sm sm:text-base md:text-lg text-[var(--text-secondary)] max-w-2xl mx-auto leading-relaxed mb-8 px-4">
            Building production-scale AI-integrated backend systems.
            Reduced operational costs by 95% and generation time by 90%
          ...
          <div className="flex justify-center gap-4 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--text-secondary)] hover:text-[var(--accent-secondary)] transition-all duration-200 hover:scale-110 p-2"
              aria-label="LinkedIn"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
